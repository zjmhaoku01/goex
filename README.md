...
[English](https://github.com/zjmhaoku01/goex/blob/dev/README_en.md)

### wiki文档

[文档](https://github.com/zjmhaoku01/goex/wiki)
...
``` go get github.com/zjmhaoku01/goex ```

>建议go mod 管理依赖
``` 
require (
          github.com/zjmhaoku01/goex latest
)
```
